...
export function createPWAConfig(options: PWAViteConfigOptions = {}): UserConfig {
  ...
  const defaultPWAOptions: Partial<VitePWAOptions> = {
    ...
    manifest: {
      ...
      display: "standalone",
      description: manifest.description || "Meal Planner",
      name: manifest.name || "Meal Planner",
      icons: [
        {
          src: "pwa-192x192.png",
          sizes: "192x192",
      ...
      screenshots: [
        ...
        },
        {
          ...
          type: "image/png",
          form_factor: "narrow",
          label: "Meal Planner on Phone",
        },
      ],
      short_name: manifest.shortName || "Meal Planner",
