import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{G as n,i as r,n as i,r as a}from"./iframe-BLBebFNs.js";import{at as o,t as s}from"./dist-DaOtRWkO.js";import{n as c,t as l}from"./clsx-_2dUCx3I.js";import{n as u,t as d}from"./QuickMenu-DeF7q1XY.js";import{W as f,c as p,g as m,gt as h,i as g,mt as _,t as v,v as y}from"./esm-bnb9huIp.js";import{n as b,t as x}from"./UserAvatar-CqMUfbEt.js";function S(e){return[{id:`recipes`,name:e.formatMessage({description:`NavMenuItems: menu-item - recipes`,defaultMessage:`Recipes`,id:`BpvAE5`}),shortName:e.formatMessage({description:`NavMenuItems: menu-item - recipes (short, mobile tab bar)`,defaultMessage:`Recipes`,id:`lzH6R6`}),href:`#/`,icon:(0,C.jsx)(h,{className:`h-[18px] w-[18px]`})},{id:`plan`,name:e.formatMessage({description:`NavMenuItems: menu-item - plan`,defaultMessage:`Plan`,id:`SIwWzu`}),shortName:e.formatMessage({description:`NavMenuItems: menu-item - plan (short, mobile tab bar)`,defaultMessage:`Plan`,id:`DmSF9w`}),href:`#/plan`,icon:(0,C.jsx)(m,{className:`h-[18px] w-[18px]`})},{id:`week`,name:e.formatMessage({description:`NavMenuItems: menu-item - this week`,defaultMessage:`This week`,id:`myl/z5`}),shortName:e.formatMessage({description:`NavMenuItems: menu-item - this week (short, mobile tab bar)`,defaultMessage:`Week`,id:`/4Y51F`}),href:`#/week`,icon:(0,C.jsx)(_,{className:`h-[18px] w-[18px]`})},{id:`shop`,name:e.formatMessage({description:`NavMenuItems: menu-item - shopping`,defaultMessage:`Shopping`,id:`LS5BYx`}),shortName:e.formatMessage({description:`NavMenuItems: menu-item - shopping (short, mobile tab bar)`,defaultMessage:`Shopping`,id:`aAqsh5`}),href:`#/shopping`,icon:(0,C.jsx)(y,{className:`h-[18px] w-[18px]`})},{id:`community`,name:e.formatMessage({description:`NavMenuItems: menu-item - community`,defaultMessage:`Community`,id:`b6ZYZt`}),shortName:e.formatMessage({description:`NavMenuItems: menu-item - community (short, mobile tab bar)`,defaultMessage:`Friends`,id:`YfA5jn`}),href:`#/community`,icon:(0,C.jsx)(g,{className:`h-[18px] w-[18px]`})}]}var C,w=e((()=>{v(),C=r()}));function T(e){window.location.hash=e.replace(/^#/,``)}function E(){return(0,k.jsxs)(`svg`,{viewBox:`0 0 24 24`,className:`text-accent h-[26px] w-[26px] flex-none`,"aria-hidden":`true`,children:[(0,k.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10.2`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`}),(0,k.jsx)(`circle`,{cx:`12`,cy:`12`,r:`6.6`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.1`,opacity:`0.4`}),(0,k.jsx)(`path`,{d:`M8.7 12.1L11.2 14.6L15.5 9.9`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.9`,strokeLinecap:`round`,strokeLinejoin:`round`})]})}function D({quickMenu:e,avatarName:t,avatarEmail:n,activeTab:r=`recipes`,onTabChange:i,weekPicker:s,accountMenu:c}){let u=a(),[m,h]=(0,O.useState)(!1),g=(0,O.useMemo)(()=>S(u),[u]),_=n?`@${n.split(`@`)[0]}`:``;function v(e){e.disabled||(i?i(e.id):T(e.href))}let y=u.formatMessage({description:`NavbarContent: heading - app title in navbar`,defaultMessage:`Meal Planner`,id:`MwZQf8`}),b=u.formatMessage({description:`NavbarContent: tooltip - disabled nav item not built yet`,defaultMessage:`Coming soon`,id:`3rWi7W`});return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`header`,{className:`bg-background/70 border-border sticky top-0 z-40 border-b backdrop-blur-lg dark:shadow-[0_1px_0_rgba(0,0,0,0.5)]`,children:(0,k.jsxs)(`div`,{className:`mx-auto flex h-16 max-w-[1240px] items-center justify-between gap-2.5 px-3.5 min-[760px]:gap-4 min-[760px]:px-6`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`flex min-w-0 shrink-0 items-center gap-2`,onClick:()=>i?i(`recipes`):T(`#/`),"aria-label":y,children:[(0,k.jsx)(E,{}),(0,k.jsx)(`span`,{className:`truncate text-xl font-normal`,style:{fontFamily:`var(--font-family-display)`},children:y})]}),(0,k.jsx)(`nav`,{className:`hidden min-w-0 flex-1 items-center justify-center gap-5 min-[760px]:flex`,"aria-label":u.formatMessage({description:`NavbarContent: aria-label - navigation tabs`,defaultMessage:`Navigation`,id:`3R8Sia`}),children:g.map(e=>{let t=e.id===r;return(0,k.jsxs)(`button`,{type:`button`,onClick:()=>v(e),"aria-current":t?`page`:void 0,"aria-disabled":e.disabled,title:e.disabled?b:void 0,className:l(`inline-flex items-center gap-1.5 px-1.5 py-2 text-sm whitespace-nowrap transition-colors min-[1080px]:px-0.5`,e.disabled?`text-muted/50 cursor-default`:t?`text-foreground font-medium shadow-[inset_0_-2px_0_0_var(--accent)]`:`text-muted hover:text-foreground cursor-pointer`),children:[e.icon,(0,k.jsx)(`span`,{className:`sr-only min-[1080px]:not-sr-only`,children:e.name})]},e.id)})}),(0,k.jsxs)(`div`,{className:`flex shrink-0 items-center gap-2.5`,children:[s,(0,k.jsxs)(o,{isOpen:m,onOpenChange:h,children:[(0,k.jsx)(o.Trigger,{"data-testid":`home-page__menu-button`,children:(0,k.jsxs)(`div`,{className:`border-border bg-surface flex cursor-pointer items-center gap-2 rounded-full border py-0.5 pr-2.5 pl-0.5`,children:[(0,k.jsx)(x,{name:t,size:`sm`}),_&&(0,k.jsx)(`span`,{className:`text-muted hidden text-xs font-medium min-[760px]:inline`,children:_})]})}),(0,k.jsx)(o.Content,{placement:`bottom end`,children:(0,k.jsxs)(o.Dialog,{className:`w-63 overflow-hidden p-0`,children:[(0,k.jsxs)(`div`,{className:`border-separator flex items-center gap-2.5 border-b p-3.5`,children:[(0,k.jsx)(x,{name:t,size:`md`}),(0,k.jsxs)(`span`,{className:`flex min-w-0 flex-col`,children:[(0,k.jsx)(`span`,{className:`truncate text-sm font-semibold`,children:t}),_&&(0,k.jsx)(`span`,{className:`text-muted truncate text-xs`,children:_})]})]}),c&&(0,k.jsxs)(`div`,{className:`border-separator flex flex-col border-b p-2`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`hover:bg-surface-secondary flex cursor-pointer items-center gap-2.5 rounded-md px-2.5 py-2 text-sm`,onClick:()=>{h(!1),c.onOpenProfile()},"data-testid":`navbar__my-profile`,children:[(0,k.jsx)(p,{className:`h-[18px] w-[18px]`}),u.formatMessage({description:`NavbarContent: menu-item - open your own community profile`,defaultMessage:`My profile`,id:`izLyKM`})]}),(0,k.jsxs)(`button`,{type:`button`,className:`hover:bg-surface-secondary flex cursor-pointer items-center gap-2.5 rounded-md px-2.5 py-2 text-sm`,onClick:()=>{h(!1),c.onOpenInbox()},"data-testid":`navbar__inbox`,children:[(0,k.jsx)(f,{className:`h-[18px] w-[18px]`}),u.formatMessage({description:`NavbarContent: menu-item - open the recommendations inbox`,defaultMessage:`Inbox`,id:`TsXLmk`}),c.unreadCount>0&&(0,k.jsx)(`span`,{className:`bg-accent text-accent-foreground ml-auto rounded-full px-2 py-0.5 text-[10px] font-semibold`,children:u.formatMessage({description:`NavbarContent: badge - unread recommendations`,defaultMessage:`{count} new`,id:`co8SjV`},{count:c.unreadCount})})]})]}),(0,k.jsx)(`div`,{className:`p-2`,children:(0,k.jsx)(d,{onSettings:()=>{h(!1),e.onSettings()},onLogout:()=>{h(!1),e.onLogout()},onSearch:()=>{h(!1),e.onSearch()}})})]})})]})]})]})}),(0,k.jsx)(`nav`,{className:`border-border bg-background/85 fixed inset-x-0 bottom-0 z-40 flex h-[62px] items-stretch border-t backdrop-blur-lg min-[760px]:hidden`,style:{paddingBottom:`env(safe-area-inset-bottom)`},"aria-label":y,children:g.map(e=>{let t=e.id===r;return(0,k.jsxs)(`button`,{type:`button`,onClick:()=>v(e),"aria-current":t?`page`:void 0,"aria-disabled":e.disabled,className:l(`flex flex-1 flex-col items-center justify-center gap-1 px-1 text-[10px] tracking-[0.01em]`,e.disabled?`text-muted/50`:t?`text-accent font-medium`:`text-muted`),children:[(0,k.jsx)(`span`,{className:l(`h-0.5 w-5 rounded-full`,t&&!e.disabled?`bg-accent`:`bg-transparent`)}),e.icon,(0,k.jsx)(`span`,{className:`max-w-full truncate`,children:e.shortName})]},e.id)})})]})}var O,k,A=e((()=>{O=t(n(),1),v(),s(),c(),i(),w(),u(),b(),k=r(),D.__docgenInfo={description:``,methods:[],displayName:`NavbarContent`,props:{quickMenu:{required:!0,tsType:{name:`QuickMenuProps`},description:``},avatarName:{required:!0,tsType:{name:`string`},description:``},avatarEmail:{required:!1,tsType:{name:`string`},description:``},activeTab:{required:!1,tsType:{name:`string`},description:``,defaultValue:{value:`"recipes"`,computed:!1}},onTabChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(id: string) => void`,signature:{arguments:[{type:{name:`string`},name:`id`}],return:{name:`void`}}},description:``},weekPicker:{required:!1,tsType:{name:`ReactNode`},description:`The week picker that sits left of the account chip — mounted by the route as a controller.`},accountMenu:{required:!1,tsType:{name:`signature`,type:`object`,raw:`{
  unreadCount: number;
  onOpenProfile: () => void;
  onOpenInbox: () => void;
