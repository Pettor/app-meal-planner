import{i as e}from"./preload-helper-CT_b8DTk.js";import{i as t}from"./iframe-BLBebFNs.js";import{n,o as r}from"./RecipeSampleData-BF9_X84N.js";import{n as i,t as a}from"./RecipeCard-BXXktSEJ.js";var o,s,c,l,u,d,f,p,m,h,g,_,v;e((()=>{i(),r(),o=t(),{expect:s,fn:c}=__STORYBOOK_MODULE_TEST__,l={component:a,title:`Display/Recipe Card`,tags:[`autodocs`],decorators:[e=>(0,o.jsx)(`div`,{className:`w-64`,children:(0,o.jsx)(e,{})})]},u=n[0],d=n[6],f={recipe:u,onOpen:c(),onRemove:c()},p={args:f},m={args:{...f,recipe:n[5]}},h={args:{recipe:d,showSaveAction:!0,onOpen:c(),onSave:c()}},g={args:{recipe:{...d,isSaved:!0},showSaveAction:!0,onOpen:c(),onSave:c()}},_={args:f,play:async({args:e,canvas:t,userEvent:n})=>{await n.click(t.getByRole(`button`,{name:`Open ${u.title}`})),await s(e.onOpen).toHaveBeenCalledWith(u.id)}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: defaultArgs
}`,...p.parameters?.docs?.source}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
    recipe: SampleRecipes[5]!
  }
