import{i as e}from"./preload-helper-CT_b8DTk.js";import{i as t}from"./iframe-BLBebFNs.js";import{n,o as r}from"./RecipeSampleData-BF9_X84N.js";import{n as i,t as a}from"./CommunityCardHeader-BNWa14iI.js";import{i as o,n as s,r as c}from"./CommunitySampleData-TKcJX8eP.js";import{a as l,c as u,l as d,s as f}from"./CommunityUtils-DWRFMwN9.js";import{n as p,t as m}from"./SharedWeekCard-B_DB3BsS.js";var h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{p(),i(),o(),l(),r(),h=t(),{expect:g,fn:_}=__STORYBOOK_MODULE_TEST__,v={component:m,title:`Display/Shared Week Card`,tags:[`autodocs`],decorators:[e=>(0,h.jsx)(`div`,{className:`w-180`,children:(0,h.jsx)(e,{})})]},y=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],b=c[0],x=s.find(e=>e.id===b.ownerId),S={week:{id:b.id,title:b.title,note:b.note,tags:d(b,n),days:f(b,n,y),photos:u(b,n),usesLabel:`31 uses`,agoLabel:`2d ago`},onRecommend:_(),onUse:_()},C={args:{...S,showAgeBesideTitle:!0}},w={args:{...S,header:(0,h.jsx)(a,{person:x,action:`shared a week`,ago:`2d ago`,onOpenProfile:_()})}},T={args:{...S,header:(0,h.jsx)(a,{person:x,showHandle:!0,withBorder:!0,ago:`2d ago`,onOpenProfile:_()})}},E={args:S,play:async({args:e,canvas:t,userEvent:n})=>{await n.click(t.getByRole(`button`,{name:`Use this week`})),await g(e.onUse).toHaveBeenCalled()}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    ...defaultArgs,
